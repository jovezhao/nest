 ...
 */
public final class DefaultLongIdentifierGenerator implements LongIdentifierGenerator {
     ...
     * 构造函数
     */
    public DefaultLongIdentifierGenerator() {
        this.workerId = 0;
        this.datacenterId = 0;
    }
     ...
     */
    public DefaultLongIdentifierGenerator(long workerId, long datacenterId) {
