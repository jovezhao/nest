...
public class DateUtils {
     ...
     * 检查两个时间是否有交集
     *
     * @param dateStart1 第一个时间的开始
     * @param dateEnd1   第一个时间的结束
     * @param dateStart2 第二个时间的开始
     * @param dateEnd2   第二个时间的结束
     * @return
     */
    public static boolean isTimeMixed(Date dateStart1, Date dateEnd1, Date dateStart2, Date dateEnd2) {
        //
        if ((null == dateStart1) || (null == dateEnd1) || (null == dateStart2) || (null == dateEnd2)) {
            return false;
        }
        //
        if ((dateStart1.after(dateStart2)) && (dateStart1.before(dateEnd2))) {
            return true;
        }
        if ((dateEnd1.after(dateStart2)) && (dateEnd1.before(dateEnd2))) {
            return true;
        }
        //
        if ((dateStart2.after(dateStart1)) && (dateStart2.before(dateEnd1))) {
            return true;
        }
        if ((dateEnd2.after(dateStart1)) && (dateEnd2.before(dateEnd1))) {
            return true;
        }
        return false;
    }
